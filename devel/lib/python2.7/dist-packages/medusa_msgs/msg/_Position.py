...
"""autogenerated by genpy from medusa_msgs/Position.msg. Do not edit."""
import codecs
import sys
...
class Position(genpy.Message):
  _md5sum = "755088430ff20c005d93673101a6169a"
  _type = "medusa_msgs/Position"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """#Position Info

float64 latitude
float64 longitude
float64 depth
float64 altitude"""
  __slots__ = ['latitude','longitude','depth','altitude']
