...
(cl:defmethod cl:initialize-instance :after ((m <Position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name medusa_msgs-msg:<Position> is deprecated: use medusa_msgs-msg:Position instead.")))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader medusa_msgs-msg:latitude-val is deprecated.  Use medusa_msgs-msg:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader medusa_msgs-msg:longitude-val is deprecated.  Use medusa_msgs-msg:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'depth-val :lambda-list '(m))
(cl:defmethod depth-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader medusa_msgs-msg:depth-val is deprecated.  Use medusa_msgs-msg:depth instead.")
  (depth m))

(cl:ensure-generic-function 'altitude-val :lambda-list '(m))
(cl:defmethod altitude-val ((m <Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader medusa_msgs-msg:altitude-val is deprecated.  Use medusa_msgs-msg:altitude instead.")
  (altitude m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Position>)))
  ...
  (cl:format cl:nil "#Position Info~%~%float64 latitude~%float64 longitude~%float64 depth~%float64 altitude~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Position)))
  "Returns full string definition for message of type 'Position"
  (cl:format cl:nil "#Position Info~%~%float64 latitude~%float64 longitude~%float64 depth~%float64 altitude~%~%"))
